...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Jul 2026 pada 09.45
...
INSERT INTO `pengajuan_surat` (`id_pengajuan`, `id_mahasiswa`, `jenis_surat`, `no_telepon`, `keterangan`, `nomor_surat`, `status`, `tanggal_pengajuan`) VALUES
(40, 2, 'Surat Keterangan Aktif', '08514206967', 'GgGua cuy bikinin buatdaftar mbg', NULL, 'diajukan', '2026-07-25 20:07:56'),
(41, 2, 'Surat Keterangan Aktif', '123456789012', 'pengen surat', 'ggcuy_1', 'selesai', '2026-07-25 20:27:36'),
(42, 2, 'Surat Pengantar Penelitian', '0851420696767', 'saya mau magang di mbg di depan kampus', NULL, 'diajukan', '2026-07-25 21:02:38');
...
--
-- Dumping data untuk tabel `riwayat_draf`
--

INSERT INTO `riwayat_draf` (`id_riwayat`, `id_pengajuan`, `versi`, `file_draf`, `catatan_revisi`, `tanggal_unggah`) VALUES
(24, 41, 1, '1784986421_SUSUNAN ACARA WORKSHOP PPHI 2026.docx', NULL, '2026-07-25 20:33:41'),
(25, 41, 2, '1784986466_ACC_Denah dan No Meja Market Day & Hut Kosmart.pdf', 'Telah di-ACC Kaprodi', '2026-07-25 20:34:26');
...
(4, 'sesel', 'sesel', 'mahasiswa', 'Selma Nur Fauziah', '102124110006', NULL);
